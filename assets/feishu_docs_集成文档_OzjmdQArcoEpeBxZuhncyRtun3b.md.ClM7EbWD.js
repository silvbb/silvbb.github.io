import{_ as s,c as n,o as a,ab as p}from"./chunks/framework.ykMB-S_y.js";const m=JSON.parse('{"title":"服务器（nginx apache）","description":"","frontmatter":{"title":"服务器（nginx apache）","urlname":"OzjmdQArcoEpeBxZuhncyRtun3b","date":"2025-04-02 11:44:59","updated":"2025-04-02 23:58:52"},"headers":[],"relativePath":"feishu/docs/集成文档/OzjmdQArcoEpeBxZuhncyRtun3b.md","filePath":"feishu/docs/集成文档/OzjmdQArcoEpeBxZuhncyRtun3b.md","lastUpdated":1744221708000}'),e={name:"feishu/docs/集成文档/OzjmdQArcoEpeBxZuhncyRtun3b.md"},l=p(`<h2 id="_1-apache" tabindex="-1">1，apache <a class="header-anchor" href="#_1-apache" aria-label="Permalink to &quot;1，apache&quot;">​</a></h2><p>改变其端口，编辑配置文件</p><p>sudo nano /etc/apache2/ports.conf</p><h2 id="_2-nginx" tabindex="-1">2, nginx <a class="header-anchor" href="#_2-nginx" aria-label="Permalink to &quot;2, nginx&quot;">​</a></h2><p>请求处理流程：</p><p>所有请求 -&gt; Nginx 监控的端口 -&gt; 配置location 代理到 127.0.0.1:8000（自己设定） -&gt; 后台框架应用（比如Laravel 应用）</p><p>172.30.33.xxx是NGINX反向代理服务的网段（来自官方文档），所以要添加信任才能公网访问，不然会出现 400 bad request 的错误。</p><div class="language-undefined vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">undefined</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" style="--shiki-light:#24292e;--shiki-dark:#adbac7;--shiki-light-bg:#fff;--shiki-dark-bg:#22272e;" tabindex="0"><code><span class="line"><span>http:</span></span>
