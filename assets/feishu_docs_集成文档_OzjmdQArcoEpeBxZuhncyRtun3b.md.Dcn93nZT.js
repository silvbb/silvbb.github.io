import{_ as s,c as n,o as a,ab as p}from"./chunks/framework.CZX4lbMe.js";const m=JSON.parse('{"title":"服务器（nginx apache）","description":"","frontmatter":{"title":"服务器（nginx apache）","urlname":"OzjmdQArcoEpeBxZuhncyRtun3b","date":"2025-04-02 11:44:59","updated":"2025-04-02 23:58:52"},"headers":[],"relativePath":"feishu/docs/集成文档/OzjmdQArcoEpeBxZuhncyRtun3b.md","filePath":"feishu/docs/集成文档/OzjmdQArcoEpeBxZuhncyRtun3b.md","lastUpdated":1744562221000}'),e={name:"feishu/docs/集成文档/OzjmdQArcoEpeBxZuhncyRtun3b.md"},l=p(`<h2 id="_1-apache" tabindex="-1">1，apache <a class="header-anchor" href="#_1-apache" aria-label="Permalink to &quot;1，apache&quot;">​</a></h2><p>改变其端口，编辑配置文件</p><p>sudo nano /etc/apache2/ports.conf</p><h2 id="_2-nginx" tabindex="-1">2, nginx <a class="header-anchor" href="#_2-nginx" aria-label="Permalink to &quot;2, nginx&quot;">​</a></h2><p>请求处理流程：</p><p>所有请求 -&gt; Nginx 监控的端口 -&gt; 配置location 代理到 127.0.0.1:8000（自己设定） -&gt; 后台框架应用（比如Laravel 应用）</p><p>172.30.33.xxx是NGINX反向代理服务的网段（来自官方文档），所以要添加信任才能公网访问，不然会出现 400 bad request 的错误。</p><div class="language-undefined vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">undefined</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" style="--shiki-light:#24292e;--shiki-dark:#adbac7;--shiki-light-bg:#fff;--shiki-dark-bg:#22272e;" tabindex="0"><code><span class="line"><span>http:</span></span>
...
<span class="line"><span>  [2025-04-02 14:13:21] local.INFO: 收到天猫精灵请求 {&quot;data&quot;:{&quot;intentName&quot;:&quot;ai.dueros.common.default_intent&quot;,&quot;slotEntities&quot;:[],&quot;utterance&quot;:&quot;你好&quot;},&quot;headers&quot;:{&quot;host&quot;:[&quot;tm.jwisdom.fun&quot;],&quot;x-real-ip&quot;:[&quot;172.23.96.1&quot;],&quot;x-forwarded-for&quot;:[&quot;172.23.96.1&quot;],&quot;x-forwarded-proto&quot;:[&quot;https&quot;],&quot;connection&quot;:[&quot;upgrade&quot;],&quot;content-length&quot;:[&quot;87&quot;],&quot;user-agent&quot;:[&quot;curl/8.5.0&quot;],&quot;accept&quot;:[&quot;*/*&quot;],&quot;content-type&quot;:[&quot;application/json&quot;]}}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>-v (--verbose) ：显示详细通信过程</p><p>-X (--request) ：指定 HTTP 请求方法</p><p>-k 参数忽略 SSL 证书验证</p>`,33),i=[l];function r(t,c,b,o,u,d){return a(),n("div",null,i)}const k=s(e,[["render",r]]);export{m as __pageData,k as default};
