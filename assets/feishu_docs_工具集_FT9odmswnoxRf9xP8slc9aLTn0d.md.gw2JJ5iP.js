import{_ as n,c as a,o as p,a8 as e}from"./chunks/framework.D4xYyhHC.js";const d=JSON.parse('{"title":"终端操作常识","description":"","frontmatter":{"title":"终端操作常识","urlname":"FT9odmswnoxRf9xP8slc9aLTn0d","date":"2025-03-28 13:53:18","updated":"2025-04-04 13:57:47"},"headers":[],"relativePath":"feishu/docs/工具集/FT9odmswnoxRf9xP8slc9aLTn0d.md","filePath":"feishu/docs/工具集/FT9odmswnoxRf9xP8slc9aLTn0d.md","lastUpdated":1743995925000}'),l={name:"feishu/docs/工具集/FT9odmswnoxRf9xP8slc9aLTn0d.md"};function i(r,s,c,b,o,t){return p(),a("div",null,s[0]||(s[0]=[e(`<h2 id="_1-windows-终端" tabindex="-1">1，Windows 终端： <a class="header-anchor" href="#_1-windows-终端" aria-label="Permalink to &quot;1，Windows 终端：&quot;">​</a></h2><ol><li><p>Command Prompt (cmd.exe)</p><ul><li><p>Windows 默认命令行终端</p></li><li><p>最基础的命令行界面</p></li></ul></li><li><p>PowerShell</p><ul><li><p>更现代的命令行和脚本环境</p></li><li><p>支持更复杂的命令和脚本功能</p></li></ul></li></ol><p>PowerShell (两个版本):Windows PowerShell ( powershell.exe )和PowerShell Core ( pwsh.exe )：</p><div class="language-plaintext vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" style="--shiki-light:#24292e;--shiki-dark:#adbac7;--shiki-light-bg:#fff;--shiki-dark-bg:#22272e;" tabindex="0"><code><span class="line"><span># Windows PowerShell 与 PowerShell Core 的区别</span></span>
